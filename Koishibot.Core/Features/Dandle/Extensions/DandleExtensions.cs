...
/*══════════════════【 CACHE 】══════════════════*/
	public static void EnableDandle(this IAppCache cache) =>
		cache.UpdateServiceStatus(ServiceName.Dandle, Status.Online);

	public static void DisableDandle(this IAppCache cache) =>
		cache.UpdateServiceStatus(ServiceName.Dandle, Status.Offline);
	...
	public static DandleGame GetDandleInfo(this IAppCache cache)
	{
		var dandleInfo = cache.Get<DandleGame>(CacheName.Dandle);

		return dandleInfo ?? throw new Exception("Dandle Info not in cache");
	}
	...
	public static bool DandleIsEnabled(this IAppCache cache) =>
		cache.GetStatusByServiceName(ServiceName.Dandle);
...
/*══════════════════【 SIGNALR 】══════════════════*/
	...
	public static async Task ClearDandleBoard(this ISignalrService signalr) =>
