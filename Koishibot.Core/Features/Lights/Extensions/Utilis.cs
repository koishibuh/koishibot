...
//	{
//		if (speed > 100)
//			throw new LedLightException("Speed cannot have a value more than 100.");
...
//	internal static PatternMode DetermineMode(string patternCode, string whiteCode)
//	{
//		switch (patternCode)
//		{
//			case "60":
...
//			case "62":
//				if (whiteCode == "0")
//					return PatternMode.Color;
//				else return PatternMode.WarmWhite;
//			case "2a":
//			case "2b":
//			case "2c":
//			case "2d":
