...
/*═════════════════【 ENTITY MODEL 】═════════════════*/
public class NewChatCommand : IEntity
{
...
/*══════════════════【 CONFIGURATION 】═════════════════*/
public class NewChatCommandConfig : IEntityTypeConfiguration<NewChatCommand>
{
	public void Configure(EntityTypeBuilder<NewChatCommand> builder)
	{
		builder.ToTable("NewChatCommand");
