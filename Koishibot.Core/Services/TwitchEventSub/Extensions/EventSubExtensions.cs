...
public static class EventSubExtensions
{
	...
	public static PollStartedEvent ConvertToEvent(this ChannelPollBeginArgs args)
	{
		return new PollStartedEvent(
	...
	public static PollEndedEvent ConvertToEvent(this ChannelPollEndArgs args)
	{
	...
	{
		return "98683749" == raid.Notification.Payload.Event.ToBroadcasterUserId;
	}

	public static (TwitchUserDto user, int viewerCount) ConvertToDto(this ChannelRaidArgs e)
	{
		var user = new TwitchUserDto(
			e.Notification.Payload.Event.FromBroadcasterUserId,
			e.Notification.Payload.Event.FromBroadcasterUserLogin,
			e.Notification.Payload.Event.FromBroadcasterUserName);
