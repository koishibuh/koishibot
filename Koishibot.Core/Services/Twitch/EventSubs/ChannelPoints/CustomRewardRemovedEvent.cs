...
/// <summary>
/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelchannel_points_custom_rewardremove">Twitch Documentation</see><br/>
/// When a custom channel points reward has been removed from the specified channel.<br/>
/// Required Scopes: channel:read:redemptions or channel:manage:redemptions<br/>
/// </summary>
public class CustomRewardRemovedEvent
{
	///<summary>
	...
	///Counts against the max_per_stream limit. Null if the broadcasters stream isn’t live or max_per_stream isn’t enabled.
	///</summary>
