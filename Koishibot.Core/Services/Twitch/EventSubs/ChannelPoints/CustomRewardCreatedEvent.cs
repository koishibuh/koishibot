...
/// <summary>
/// <see href="https://dev.twitch.tv/docs/eventsub/eventsub-subscription-types/#channelchannel_points_custom_rewardadd">Twitch Documentation</see><br/>
/// When a custom channel points reward has been created for the specified channel.<br/>
/// Required Scopes: channel:read:redemptions or channel:manage:redemptions<br/>
/// </summary>
public class CustomRewardCreatedEvent
{
	///<summary>
	...
	///<summary>
	///Set of custom images of 1x, 2x and 4x sizes for the reward.<br/>
	///Can be null if no images have been uploaded.<br/>
	///(28px, 56px, 112px)
	///</summary>
	...
	///<summary>
	///Set of default images of 1x, 2x and 4x sizes for the reward.<br/>
	///(28px, 56px, 112px)
	///</summary>
