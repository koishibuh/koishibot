...
public class ResubMessageEvent
{
    ...
    public string ResubscriberUserId { get; set; } = string.Empty;

    /// <summary>
    /// The user login of the user who sent a resubscription chat message. (Lowercase)
    /// </summary>
    [JsonPropertyName("user_login")]
    public string ResubscriberUserLogin { get; set; } = string.Empty;

    /// <summary>
    /// The user display name of the user who a resubscription chat message.
    /// </summary>
    [JsonPropertyName("user_name")]
    public string ResubscriberUserName { get; set; } = string.Empty;
