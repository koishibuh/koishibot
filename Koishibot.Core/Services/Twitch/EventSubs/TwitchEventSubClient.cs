    ...
    ) : ITwitchEventSubClient
{
    ...
    public EventSubRequest CreateEventSubRequest
    ...
    public async Task<TwitchApiResponse<EventSubResponse>?> RequestEventSubNotifications
        (HttpClient httpClient, EventSubRequest request)
    {
...
//		var subscriptionTasks = events.Select(x => RequestEventSubNotifications(
//			new EventSubRequest
//			{
//				Type = x,
//				Version = EventSubHelper.GetVersionForType(x),
//				Condition = EventSubHelper.GetConditionsForType(x, streamerId),
//				Transport = new EventSubTransportRequest { SessionId = sessionId },
//			})).ToList();
