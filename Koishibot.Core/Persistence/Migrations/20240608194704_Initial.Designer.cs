...
namespace Koishibot.Core.Migrations
{
    ...
    [Migration("20240608194704_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Koishibot.Core.Features.IncomingRaids.Models.IncomingRaid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Koishibot.Core.Features.OutgoingRaids.Models.OutgoingRaid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Koishibot.Core.Features.OutgoingRaids.Models.OutgoingRaid", b =>
                {
                    ...
                    b.HasOne("Koishibot.Core.Features.StreamInformation.Models.TwitchStream", "TwitchStream")
                        ...
                        .HasForeignKey("Koishibot.Core.Features.OutgoingRaids.Models.OutgoingRaid", "TwitchStreamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
