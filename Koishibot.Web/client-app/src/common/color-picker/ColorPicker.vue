...
import { setColorValue, rgb2hex } from '@/common/color-picker/color-composible';

import Saturation from '@/common/color-picker/ColorSaturation.vue';
import Hue from '@/common/color-picker/ColorHue.vue';
import Alpha from '@/common/color-picker/ColorAlpha.vue';
import Preview from '@/common/color-picker/ColorPreview.vue';
import Sucker from '@/common/color-picker/ColorSucker.vue';
import Box from '@/common/color-picker/ColorBox.vue';
import Colors from '@/common/color-picker/ColorColors.vue';
